...
#
#   docker/build.sh                 -> ephico2real/k8s-metrics-aggr:<VERSION>-h1-g<sha>
#   docker/build.sh 1.2.3-test      -> ephico2real/k8s-metrics-aggr:1.2.3-test
#
...
TAG="${1:-${VERSION}-h2-g${SHA}}"  # default pass tracks the current hardening pass of this repo
IMAGE="ephico2real/k8s-metrics-aggr"
